...
public class Simulation {
    ...
    public void run() {
        rectangularMap = new RectangularMap(5, 5, 2, 2);
        ...
        Animal animal1 = new Animal(new Vector2d(1, 1), 100, gen1, rectangularMap);
        Animal animal2 = new Animal(new Vector2d(2, 2), 100, gen2, rectangularMap);
        Animal animal3 = new Animal(new Vector2d(3, 2), 100, gen2, rectangularMap);
